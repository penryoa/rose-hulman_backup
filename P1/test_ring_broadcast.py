...
required_files=['some_test_helpers.c','more_test_helpers.c']
...
for i in range(1,num_procs):
    ...
    for j in range(len(data)):
	   ...
	   result[i]=0
	   print "Error, on rank "+str(i)+" the "+str(j)+"th recieve should come from rank "+str(i-1)+" and contain data "+str(data[j])
