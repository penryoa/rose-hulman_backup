...
/**
 * 
 * This class represents a box with a dynamic color and position which can be
 * drawn to the screen and updated over time
 * 
...
public class DynamicBox {
	...
	// This method draws the box using the intensity and color multipliers to
	// properly calculate a color
	public void drawOn(Graphics2D g) {
		g.setColor(new Color(redMultiplier * intensity, greenMultiplier * intensity, blueMultiplier * intensity));
		g.fill(new Rectangle(x, y, width, height));
	}

	// This method moves the box until it goes beyond an edge and then it
	// changes direction
