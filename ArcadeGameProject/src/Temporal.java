 ...
 * 
 * This code is copied over from Ball Worlds.
 * 
...
public interface Temporal {
	...
	void die();
	/**
	 * Sets whether this object should be paused. When paused, the object shouldn't
	 * change state as timePassed() is called.
	 * 
	 * @param isPaused
