...
//		g2.setFont(new Font("Comic Sans", 0, 16));
		g2.setColor(Color.YELLOW);
		g2.drawString(this.score + "", (int)this.box.x, (int)this.box.y+(int)this.box.height);
	}
}
