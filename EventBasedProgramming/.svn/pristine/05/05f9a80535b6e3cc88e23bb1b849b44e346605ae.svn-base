...
public class BreakfastMain {
	...
	public void createWindows() {
		...
		ActionListener innerEatPorridge = new InnerEatPorridgeListener();
		eatButton.addActionListener(innerEatPorridge);
	...
	private class InnerEatPorridgeListener implements ActionListener {
