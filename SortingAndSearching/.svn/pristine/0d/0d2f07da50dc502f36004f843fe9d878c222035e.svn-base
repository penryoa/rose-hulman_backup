...
public class BinarySearch {
	...
	public static void main(String[] args) {
		...
		for (int n = 10; n < 100; n++) {
			...
			System.out.println(MessageFormat.format("{0} belongs at index {1}.", value, result));
			System.out.println(MessageFormat.format("Searched {0} elements in {1} ms.", n, timer.getElapsedTime()));
		}
	}
	 ...
	 *         be inserted if it doesn't appear in the array
	 */
	private static <E extends Comparable<E>> int bsHelper(E[] array, E value, int low, int high) {
