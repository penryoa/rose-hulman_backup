...
public class InsertionSort {
	...
	public static void main(String[] args) {
		...
		System.out.println(MessageFormat.format("Sorted {0} elements in {1} ms.", n, timer.getElapsedTime()));
	}
	...
	public static <E extends Comparable<E>> void insertionSort(E[] array) {
		...
		for (int nextIndex = 1; nextIndex < n; nextIndex++) {
			...
			while (insertIndex > 0 && array[insertIndex - 1].compareTo(next) > 0) {
			 ...
			 * are sorted
			 */
			System.out.println("outsideLoopCount: " + outsideLoopCount + "      compareToCount: " + compareToCount);
